...
public class BluetoothActivity extends AppCompatActivity {
    ...
    private ConvertVectorIntoString myVectorConverter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myVectorConverter = new ConvertVectorIntoString();

        try {

            myId = theComManager.openCom("BLUETOOTH");
    ...
    protected void onResume() {
        ...
        theComManager.setOnComManagerListener(new CommunicationListener.ComManagerListener() {
            ...
            public void onConnection(CommunicationManager.ModuleType moduleType, int id, CommunicationManager.ModuleState moduleState, String reason) {
                if (moduleType.equals(CommunicationManager.ModuleType.BLUETOOTH) && id == myId) {
                    switch (moduleState) {
                        case CONNECTED:
                    ...
                    switch (moduleState) {
                        case LISTEN_FOR_DATA:
                            if (dataBuffer != null) {
                                ...
                                dataBuffer.toString();
                                _lElementForList.add("S: " + myVectorConverter.convertToString(dataBuffer));
